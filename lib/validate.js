  ...
  validate() {
    ...
    const getEntryExtension = fileName => {
      const files = glob.sync(`${fileName}.*`, {
        ...
        cwd: this.webpackConfig.context,
        nodir: true
      });
    ...
    // Set Default context before grepping the files
    ...
    // Check for placeholder flag 'useSlsHandlers'
    ...
    if(this.webpackConfig.entry.hasOwnProperty('useSlsHandlers')){
      this.webpackConfig.entry = lib.entries;
    }
