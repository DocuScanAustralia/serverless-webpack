  ...
  output.on('open', () => {
    ...
    _.forEach(files, filePath => {
      ...
      if (!stats.isDirectory(fullPath)) {
        ...
        /* FILE PERMISSIONS ON ZIPPED FILES */
        // If we're on windows (and we know we're targeting AMI Linux) then let's ensure that 
        // the file can be executed. 
        // Test - is the file inside a /bin/ folder? If so, set the mode to specifically 0755. 
        // Otherwise have it as 0644
        
        // 511 === 0777; 493 === 0755; 438 === 0666; 420 === 0644; 4095 === 7777
        let fileMode = filePath.indexOf('bin') > -1 ? 511 : 420;
        // Todo: Figure out integration of path separator into the indexOf
        // Todo: Experiment to see whether 0755 works as well
